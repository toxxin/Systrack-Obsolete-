 ...
 *    @thanks:      Viktor Dunaev (Р”СѓРЅР°РµРІ Р’РёРєС‚РѕСЂ), vi.k(_sobaka_)mail.ru        
 **/
class MySQL {

    // SET THESE VALUES TO MATCH YOUR DATA CONNECTION
//    private $db_host    = "mysql.easywher.mass.hc.ru";  // server name
//    private $db_user    = "easywher";       // user name
//    private $db_pass    = "poh8Grah";           // password
//    private $db_dbname  = "wwweasywhereru";           // database name
